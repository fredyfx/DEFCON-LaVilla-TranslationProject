...
namespace defconflix.Migrations
{
    ...
    [Migration("20260605232250_AddSearchVectorToSummary")]
    partial class AddSearchVectorToSummary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("defconflix.Models.Summary", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasComputedColumnSql("to_tsvector('english', coalesce(\"ShortSummary\", '') || ' ' || coalesce(\"FullSummary\", '') || ' ' || regexp_replace(coalesce(\"Keywords\"::text, ''), '[\\[\\]\",]', ' ', 'g'))", true);
            ...
            modelBuilder.Entity("defconflix.WebAPI.Models.Conference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
